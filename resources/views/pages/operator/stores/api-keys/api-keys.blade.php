<x-layouts.app>
                        ...
                        <div class="card mb-4">
                                ...
                                <div class="row g-2 align-items-center">
                                    ...
                                    <div class="col-12 col-md-8">
                                        <div class="d-flex flex-wrap justify-content-md-end gap-3">
                                            ...
                                            <a href="{{ route('operator.stores.api-keys.create', $store->id) }}">
                                                <button type="button" class="btn btn-sm btn-primary"
                                                    data-bs-toggle="modal" data-bs-target="">
                                                    <i class="bi bi-key-fill me-1" aria-hidden="true"> </i>
                                                    {{ __('stores\api-keys.create_api_key_button') }}
                                                </button>
                                            </a>
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle m-0" id="operator-keys-table" role="table">
                                        <thead>
                                            <tr>
    ...
    <x-modals.danger-modal
        ...
        form-id="operator-revoke-token-form"
        submit-text="{{ __('stores\api-keys.revoke') }}"
        method='DELETE'
    />


    <div id="operator-keys-config"
        data-keys-url="{{ route('operator.stores.api-keys', $store->id) }}"
        data-revoke-url="{{ url('operator/stores/api-keys/delete') }}"
        >
    </div>
