<x-layouts.app>
    ...
    <x-slot:title>
        {{ __('stores\stores.stores_operator') }}
    </x-slot:title>
                        ...
                        <div class="card mb-4">
                                ...
                                <div class="row g-2 align-items-center">
                                    ...
                                    <div class="col-12 col-md-8">
                                        <div class="d-flex flex-wrap justify-content-md-end gap-3">
                                            ...
                                            <a href="{{ route('operator.stores.create') }}">
                                                <button type="button" class="btn btn-sm btn-primary"
                                                    data-bs-toggle="modal" data-bs-target="">
                                                    <i class="bi bi-shop me-1" aria-hidden="true"> </i>
                                                    {{ __('stores\stores.register_store') }}
                                                </button>
                                            </a>
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle m-0" id="operator-stores-table" role="table">
                                        <thead>
                                            <tr>
    ...
    <x-modals.danger-modal
        ...
        form-id="operator-disable-store-form"
        submit-text="{{ __('stores\stores.disable') }}"
        method='DELETE'
    />

    <div id="operator-stores-config"
        data-stores-url="{{ route('operator.stores') }}"
        data-delete-url="{{ url('operator/stores/delete') }}"
        >
    </div>
