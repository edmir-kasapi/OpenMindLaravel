...
$(document).ready(function () {
    ...
    $('#admin-revoke-token-form').on('submit', function (e) {
        ...
        if (tokenId) {
            ...
            $.ajax({
                ...
                method: 'DELETE',
                data: {
                    redirect: $('#admin-revoke-token-form').data('redirect')
                },
