...
$(document).ready(function () {
    ...
    $('#admin-disable-store-form').on('submit', function (e) {
        ...
        if (storeId) {
            ...
            $.ajax({
                ...
                method: 'DELETE',
                data: {
                    redirect: $('#admin-disable-store-form').data('redirect')
                },
